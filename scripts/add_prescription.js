...
document.getElementById('addPrescriptionSubmit').addEventListener('click', function (event) {
    ...
    let payload = { employeeID: null, patientRecordNumber: null, medID: null, quantityOfTablets: null }
...
const getDoctorInfo = () => {
    const req = new XMLHttpRequest();
    const searchSelect = document.getElementById("prescribeDoctor");
...
const getPatientInfo = () => {
    ...
    const req = new XMLHttpRequest();
    const searchSelect = document.getElementById("prescribePatient");
...
const getMedicationInfo = () => {
    ...
    const req = new XMLHttpRequest();
    const searchSelect = document.getElementById("prescribeMedication");
